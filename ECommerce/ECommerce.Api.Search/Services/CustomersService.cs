...
namespace ECommerce.Api.Search.Services
{
    public class CustomersService : ICustomersService
    {
        ...
        async public Task<(bool IsSuccess, Customer Result, string ErrorMessage)> GetCustomerAsync(int customerId)
        {
            try
            {
        ...
        async public Task<(bool IsSuccess, IEnumerable<Customer> Customers, string ErrorMessage)> GetCustomersAsync()
        {
            try
            {
                try
